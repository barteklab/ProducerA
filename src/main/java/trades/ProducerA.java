...
public class ProducerA {
    public static final String PRODUCER_A_PROPERTIES = "producerA.properties";
    public static final String JOB_ID = "producerAJob";
    ...
    private Properties loadProperties() {
        ...
        try (InputStream input = ProducerA.class.getClassLoader().getResourceAsStream(PRODUCER_A_PROPERTIES)) {
